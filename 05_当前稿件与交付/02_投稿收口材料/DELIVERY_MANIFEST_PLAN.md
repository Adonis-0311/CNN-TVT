...
> **历史 v1 规划，仅保留溯源。** 当前 TVT v2 交付状态以
> `docs/TVT_EVIDENCE_CLOSURE_DELIVERY_2026-07-29.md` 为准，唯一正式计算
> 入口以 `tvt_submission/LOCAL_EXECUTION_QUEUE.md` 为准。本文中的五种子、
> v1 缓存、旧宏数量和旧 release 流程不得用于 v2。
