...
> **Historical v1 ledger.** Current TVT v2 closure and admissibility are
> controlled by
> `docs/TVT_EVIDENCE_CLOSURE_DELIVERY_2026-07-29.md`,
> `tvt_submission/configs/formal_tvt_freeze_v2.json`, and the v2 validators.
> Any v1 counts or result paths below remain provenance only.
