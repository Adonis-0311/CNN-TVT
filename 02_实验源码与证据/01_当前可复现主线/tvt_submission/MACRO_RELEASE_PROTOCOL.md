...
> **Historical v1 release protocol.** For TVT v2 use
> `validate_v2_paper_release.py` and the exact commands in
> `LOCAL_EXECUTION_QUEUE.md`. The v1 freeze, macro schema/counts,
> `validate_release.py`, and five-seed paths below are provenance only and may
> not write or validate a v2 release.
