...
> **历史 v1 操作说明，禁止执行为 v2。** 当前唯一支持的正式计算入口是
> `tvt_submission/run_v2_after_gpu_free.ps1`，精确命令与产物清单见
> `tvt_submission/LOCAL_EXECUTION_QUEUE.md`。下文的 v1 缓存、五种子、
> 55 次拟合和旧 release 命令仅保留溯源。
