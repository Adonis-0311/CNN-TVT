...
> **历史 v1 状态快照。** 本文不再控制当前工作流。请使用
> `docs/TVT_EVIDENCE_CLOSURE_DELIVERY_2026-07-29.md` 和
> `tvt_submission/LOCAL_EXECUTION_QUEUE.md`；本文中的五种子、55 次拟合、
> v1 宏/锁和旧 PDF 信息均不得提升为 v2 证据。
