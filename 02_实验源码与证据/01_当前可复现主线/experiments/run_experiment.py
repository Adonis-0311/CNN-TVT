...
def build_model(
    ...
    *,
    ...
    if canonical == "a3p_tri_proportional_teacher":
        ...
        return BuiltExperimentModel(
            ...
            zero_auxiliary,
            {
                **internal_source,
                "ablation_id": "A3\u2032",
                "display_name": "A2 plus proportional component-power teacher",
                "mask_routes": 3,
                "residual_path": True,
                "enabled_components": [
                    "modulation_ce",
                    "proportional_power_teacher",
                ],
    ...
    for model_name in models:
        for seed in seeds:
            ...
            result: dict[str, Any] = {
                ...
                "seed": seed,
                "protocol": {
                    **(paper_ablation_protocol(model_name) or {}),
                    **built.protocol,
                },
