...
> **Historical v1 snapshot.** This file preserves the 2026-07-28 five-seed
> handoff and is not an operational TVT v2 instruction. Use
> `docs/TVT_EVIDENCE_CLOSURE_DELIVERY_2026-07-29.md` for current status and
> `tvt_submission/LOCAL_EXECUTION_QUEUE.md` for the only supported v2 compute
> command. Do not reinterpret any v1 result or release path as v2 evidence.
...
Project root: `D:\CNN信号调制识别\TVT支线\02_实验源码与证据\01_当前可复现主线`
