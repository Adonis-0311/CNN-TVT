...
> **Historical v1 preregistration; superseded for every future execution.**
> The current authority is
> `tvt_submission/configs/formal_tvt_freeze_v2.json`, with rationale in
> `docs/TVT_V2_PROSPECTIVE_STATISTICAL_JUSTIFICATION.md` and operator entry in
> `tvt_submission/LOCAL_EXECUTION_QUEUE.md`. Nothing below may configure,
> validate, or populate a v2 result.
