...
> **Historical pre-remediation audit snapshot.** Findings below describe the
> reviewed 2026-07-28 tree and must not be read as current unresolved status.
> Current disposition is recorded item-by-item in
> `docs/TVT_REVIEW_RESPONSE_MATRIX.md` and
