...
> **Historical v1 build-gate description.** The executable build validator now
> selects the v2 contract through
> `tvt_submission/validate_v2_paper_release.py`. Counts and
> `validate_release.py` references below document the older contract and do
> not define v2 macro admissibility.
