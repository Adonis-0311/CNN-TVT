...
> **Historical v1 table/macro contract.** The current v2 paper bridge is
> `tvt_submission/validate_v2_paper_release.py`; the controlling initial-draft
> state is `docs/TVT_EVIDENCE_CLOSURE_DELIVERY_2026-07-29.md`. The macro counts,
> five-seed aggregations, and v1 release semantics below are provenance only.
