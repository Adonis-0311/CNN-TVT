...
**2026-08-17 current-literature addendum:**
`docs/RECENT_LITERATURE_POSITIONING_2026.md` adds DenoMAE2.0, CGPCDA, and the
2026 malicious-interference MIMO tensor paper, corrects the latter from Early
Access to assigned TVT volume/pages, and records the now-resolvable
first-author DenoMAE2.0 repository. None of those additions changes the frozen
executable family.
