...
> **Historical v1 traceability snapshot.** Design-lineage statements remain
> useful provenance, but all v1 formal-run, seed-count, and release-path rows
> are superseded by `docs/TVT_EVIDENCE_CLOSURE_DELIVERY_2026-07-29.md` and the
> v2 freeze. This file is not an execution or result-admission authority.
